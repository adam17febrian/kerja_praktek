...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary text-center">Data Perbaikan</h5>
        </div>
        <div class="card-body">
            ...
            <button data-toggle="modal" data-target="#addbarang" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah Perbaikan </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newStudentModalLabel">Tambah Perbaikan</h5>
            ...
            <div class="modal-body">
                <form action="<?= base_url('data/barang'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Masukan Jasa Perbaikan">
                    </div>
                    <div class="form-group">
