...
<body>
    <div class="content">
        <div class="title">
            <b>Body Repair H. Mahdum</b>
            <br>
            <small>Jl. Raya Tajur No. 22 Kec. Citeureup Kab. Bogor</small><br>
        ...
        <div class="transaction">
            <table class="transaction-table" cellspacong="0" cellpadding="0">
                <tr>
                    <td style="min-width: 130px">Kode Jasa</td>
                    <td style="min-width: 130px">Nama Jasa</td>
                ...
                <tr>
                    <td colspan="5" style="border-top:1px dashed; text-align:right; padding: 5px 0"><b>Total</b></td>
