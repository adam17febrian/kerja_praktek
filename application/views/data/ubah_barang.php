...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Ubah Perbaikan</h1>
                ...
                <div class="card-body">
                    <form action="<?=  base_url('data/ubahbarang'); ?>" method="post">
                        <div class="row form-group">
                            <label class="col-md-3 text-md-right" for="nama_satuan">Nama Jasa</label>
                            <div class="col-md-9">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-9">
                                <input value="<?= $barang['stok']; ?>" name="stok" type="text" class="form-control">
